...
void MainWindow::segmentSkinImage()
{
    std::cout<<"Segmentation for 2D images"<<std::endl<<std::endl;
    ...
    if(this->imageLoaded)
    {
        SkinImageSegmentationWidget * skinImageSegmentationWidget = new SkinImageSegmentationWidget();
        
        displayWidget->setPickerFlag();
        skinImageSegmentationWidget->setImage(displayWidget->getImageViewer()->GetInput());
        ...
        skinImageSegmentationWidget->setMainWindow(this);
        skinImageSegmentationWidget->show();
