...
#ifndef __itkSobelOperator5_h
#define __itkSobelOperator5_h
...
class ITK_EXPORT SobelOperator5
  : public NeighborhoodOperator<TPixel, VDimension, TAllocator>
{
public:
  /** Standard typedefs */
  typedef SobelOperator5                                        Self;
  typedef NeighborhoodOperator<TPixel, VDimension, TAllocator>  Superclass;

  itkTypeMacro(SobelOperator5, NeighborhoodOperator);
  
  SobelOperator5() {}
  SobelOperator5(const Self& other)
  ...
  virtual void PrintSelf(std::ostream &os, Indent i) const  
    { 
    os << i << "SobelOperator5 { this=" << this  << "}" << std::endl;
...
#define ITK_TEMPLATE_SobelOperator5(_, EXPORT, x, y) namespace itk { \
  _(2(class EXPORT SobelOperator5< ITK_TEMPLATE_2 x >)) \
  namespace Templates { typedef SobelOperator5< ITK_TEMPLATE_2 x > \
                                                  SobelOperator5##y; } \
  }

#if ITK_TEMPLATE_EXPLICIT
# include "Templates/itkSobelOperator5+-.h"
#endif

#if ITK_TEMPLATE_TXX
# include "itkSobelOperator5.txx"
#endif
