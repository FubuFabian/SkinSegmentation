/*=========================================================================
  ...
  Module:    itkSobelEdgeDetectionImageFilter5.txx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
void 
SobelEdgeDetectionImageFilter5<TInputImage,TOutputImage>
::GenerateInputRequestedRegion() throw (InvalidRequestedRegionError)
{
  ...
  SobelOperator5<OutputPixelType, ImageDimension> oper;
...
::GenerateData()
{
  ...
  SobelOperator5<OutputPixelType, ImageDimension> opers[ImageDimension];
