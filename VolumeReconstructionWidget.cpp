...
void VolumeReconstructionWidget::calcImageBounds()
{
	std::cout<<"Calculating images bounds"<<std::endl;
        ...
        scale = mainWindow->getDisplayWidget()->getTransformScale();
        int * imageSize = volumeImageStack.at(1)->GetDimensions();	
        
        vnl_vector<double> point1;
        point1.set_size(4);
	...
	point1[3] = 1;
        ...
        vnl_vector<double> point2;
        point2.set_size(4);    		
	point2[0] = scale[0]*(imageSize[0]-1);
	point2[1] = scale[1]*0;
        point2[2] = 0;
	point2[3] = 1;
        
        vnl_vector<double> point3;
        point3.set_size(4);
        
        point3[0] = scale[0]*0;
	point3[1] = scale[1]*(imageSize[1]-1);
        point3[2] = 0;
	point3[3] = 1;
        
        vnl_vector<double> point4;
        point4.set_size(4);
        
        point4[0] = scale[0]*(imageSize[0]-1);
	point4[1] = scale[1]*(imageSize[1]-1);
        point4[2] = 0;
	point4[3] = 1;
